  ...
  return (
    <div className="overflow-x-auto rounded-lg shadow-lg">
      <table className="min-w-full bg-white border border-gray-200">
        <thead className="bg-gradient-to-r from-purple-400 to-purple-500 text-white uppercase text-sm tracking-wide">
          <tr>
        ...
        <tbody>
          {services.map((service) => (
            ...
            >
              ...
              <td className="px-4 py-2 border truncate max-w-xs" title={service.description}>
                {service.description}
              </td>
